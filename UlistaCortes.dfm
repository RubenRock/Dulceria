object Flistacortes: TFlistacortes
  Left = 0
  Top = 0
  Caption = 'Listado de cortes'
  ClientHeight = 312
  ClientWidth = 939
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Height = 247
    Align = alClient
    DataSource = Modulo.Dslista_cortes
  ...
  object PopupActionBar1: TPopupActionBar
    Left = 72
    Top = 128
    object ImportaraExcel1: TMenuItem
      Caption = 'Importar a Excel'
      OnClick = ImportaraExcel1Click
    end
  end
end
